...
LilBro = function (args) {
    ...
    this.watch_container = function (el, focus) {
        ...
        if (el.addEventListener) {
            el.addEventListener('click', _doer_maker('click', args.callback, args.bubble), false);
            if (focus) {
                el.addEventListener('focusin', _doer_maker('focusin', args.callback, args.bubble), false);
                el.addEventListener('focusout', _doer_maker('focusout', args.callback, args.bubble), false);
            }
        } else {
            el.attachEvent('onclick', _doer_maker('click', null, args.bubble), false);
            if (focus) {
                el.attachEvent('onfocusin', _doer_maker('focusin', args.callback, args.bubble), false);
                el.attachEvent('onfocusout', _doer_maker('focusout', args.callback, args.bubble), false);
            }
        }
    }
...
LilBro.Event = function (args) {
    ...
    this.fill = function (args) {
        ...
        this.set('request_hostname', window.location.hostname);
